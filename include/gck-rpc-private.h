...
#define GCK_RPC_HANDSHAKE     "PRIVATE-GNOME-KEYRING-PKCS11-PROTOCOL-V-3"
#define GCK_RPC_HANDSHAKE_LEN (sizeof(GCK_RPC_HANDSHAKE) - 1)

#define GCK_RPC_SOCKET_EXT "pkcs11"

typedef enum _GckRpcMessageType { GCK_RPC_REQUEST = 1, GCK_RPC_RESPONSE } GckRpcMessageType;
...
int gck_rpc_message_prep(GckRpcMessage *msg, int call_id, GckRpcMessageType type);
...
int gck_rpc_message_write_space_string(GckRpcMessage *msg, CK_UTF8CHAR *buffer, CK_ULONG length);

int gck_rpc_message_write_byte_buffer(GckRpcMessage *msg, CK_BYTE_PTR arr, CK_ULONG *count_ptr);

int gck_rpc_message_write_byte_array(GckRpcMessage *msg, CK_BYTE_PTR arr, CK_ULONG num);

int gck_rpc_message_write_ulong_buffer(GckRpcMessage *msg, CK_ULONG count);

int gck_rpc_message_write_ulong_array(GckRpcMessage *msg, CK_ULONG_PTR arr, CK_ULONG num);

int gck_rpc_message_write_attribute_buffer(GckRpcMessage *msg, CK_ATTRIBUTE_PTR arr, CK_ULONG num);

int gck_rpc_message_write_attribute_array(GckRpcMessage *msg, CK_ATTRIBUTE_PTR arr, CK_ULONG num);
...
int gck_rpc_message_read_space_string(GckRpcMessage *msg, CK_UTF8CHAR *buffer, CK_ULONG length);
